...
*SCDO Control Tower — Factory Execution Loop*`
    ...
    // Production Management AI responses
    'production_daily_brief': {
      draft: '<strong>FACTORY DAILY BRIEF — ' + new Date().toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'short', day: 'numeric' }) + '</strong>\n\n' +
        '<strong>BOD STATUS: YELLOW</strong>\n\n' +
        '<strong>Output:</strong>\n' +
        '• Yesterday actual: 2,846 / 3,308 planned (86%) — 462 units behind plan\n' +
        '• WF-L1 dragging: UPH 42 (target 55), yield 70% (target 90%)\n' +
        '• WF-L2 and VN02-L1 on track\n\n' +
        '<strong>Quality:</strong>\n' +
        '• Overall FPY: 91.2% (target 93%)\n' +
        '• WF-L1 FPY at 70% — root cause: solder joint defect on main board\n' +
        '• PQE team dispatched, containment in place\n\n' +
        '<strong>Material:</strong>\n' +
        '• 2 shortages active: IC-77 (ETA slip +2d), Flex Cable (VN02)\n' +
        '• IC-77 impacts Product A W04 commit — sourcing working expedite\n' +
        '• All other materials GREEN\n\n' +
        '<strong>Decisions Needed:</strong>\n' +
        '1. Approve $120k air freight for IC-77 expedite (Sourcing, 24h)\n' +
        '2. Approve OT for WF-L1 weekend recovery shift (Factory Ops, EOD)\n\n' +
        '<strong>EOD TARGET:</strong> 3,100 units | Recovery plan active for WF-L1\n\n' +
        '<em>Generated by FDOS Production Control</em>'
    },

    'production_daily_post': {
      draft: '<strong>Factory Daily Update — ' + new Date().toLocaleDateString('en-US', { month: 'short', day: 'numeric' }) + '</strong>\n\n' +
        'Yesterday output: 2,846 / 3,308 (86%). Behind plan on WF-L1 due to yield drop (70% FPY — solder joint issue). WF-L2 and VN02 running normal.\n\n' +
        'Two material flags: IC-77 shortage affecting Product A, flex cable for VN02. Sourcing is on it.\n\n' +
        '3 active MIL items, 2 HIGH. PQE containment in place for WF-L1.\n\n' +
        'Today\'s focus: WF-L1 yield recovery + IC-77 expedite decision.\n\n' +
        'Status: YELLOW — recoverable with actions in progress.'
    },

    'production_exec_summary': {
      draft: '<strong>WEEKLY EXECUTIVE SUMMARY — Factory Operations</strong>\n' +
        '<strong>Week: 2026-W04 | Status: YELLOW</strong>\n\n' +
        '<strong>TL;DR:</strong>\n' +
        '• Weekly output trending 86% of plan (2,846 / 3,308 daily avg)\n' +
        '• 4 programs active across 3 lines — 2 programs at risk (A, B)\n' +
        '• Total gap: -36,100 units across portfolio\n' +
        '• Primary drivers: material constraint (IC-77) + yield drift (WF-L1)\n\n' +
        '<strong>Program Status:</strong>\n' +
        '• Product A: GAP -10,500 (-11.1%) — Material limited (CTB). IC-77 slip driving risk.\n' +
        '• Product B: GAP -11,800 (-23.6%) — Yield limited. Demand softness may offset.\n' +
        '• Product C: GAP -7,000 (-9.3%) — Capacity limited. Line changeover window tight.\n' +
        '• Product D: GAP -6,800 (-11.3%) — Capacity limited. Labor shortage.\n\n' +
        '<strong>Factory Health:</strong>\n' +
        '• WF-L1: YELLOW — UPH 42, Yield 70%, requires immediate intervention\n' +
        '• WF-L2: GREEN — UPH 38, Yield 94%, stable\n' +
        '• VN02-L1: GREEN — UPH 55, Yield 92%, stable\n\n' +
        '<strong>Key Asks:</strong>\n' +
        '1. Approve IC-77 expedite ($120k) to protect Product A W04 commit\n' +
        '2. Approve weekend OT for WF-L1 recovery (est. $35k)\n' +
        '3. Decision on Product B build-ahead vs demand alignment\n\n' +
        '<strong>Next Update:</strong> Daily 16:00 cut\n\n' +
        '<em>FDOS Factory Execution Loop — Weekly VP Brief</em>'
    },
